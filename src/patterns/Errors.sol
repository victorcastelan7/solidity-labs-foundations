...
// /**
//  * Inspired by the "Errors" example on solidity-by-example.org.
//  * Adapted and extended for Foundry-based testing.
//  */
// contract Errors {
...
//     function deposit() external payable {
//         // Example of a require with a string error
...
//         // Example of reverting with a custom error
//         if (amount > bal) {
...
//     /// @notice Owner can sweep all ETH to a target address.
//     function ownerSweep(address to) external {
//         if (msg.sender != owner) {
//             revert Unauthorized();
//         }
