...
contract TestModifiers is Test {
    ...
    function testStartingValueIncrements() public {
        ...
        assertEq(
            startingValue + amount, valueAfterIncrement, "startingValue (100) incremented by amount (1), totaling 101"
        );
    }
    ...
    function testStartingValueDecrements() public {
        ...
        assertEq(
            startingValue - amount, valueAfterDecrement, "startingValue (100) decremented by amount (1), totaling 99"
        );
    }
